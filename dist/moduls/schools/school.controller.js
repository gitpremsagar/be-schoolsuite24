...
export async function getSchoolDashboard(req, res) {
    try {
        const schoolId = requireSchoolId(req);
        const todayStart = new Date();
        todayStart.setUTCHours(0, 0, 0, 0);
        const [students, staff, classes, studentAttendanceToday, staffAttendanceToday, subscription,] = await Promise.all([
