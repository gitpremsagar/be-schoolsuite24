...
import { createStaff, deleteStaff, getMyStaffProfile, getStaff, listStaff, purgeStaff, updateStaff, } from "./staff.controller.js";
const router = Router();
router.use(requireAuth, requireSchoolAccess, requireActiveSubscription);
router.get("/me", requireRoles("ADMIN", "TEACHER", "EMPLOYEE"), getMyStaffProfile);
