...
import { createExamination, deleteExamination, getExamination, listExaminations, listMarkSheets, listMyMarkSheets, publishMarkSheets, saveMarkSheets, updateExamination, } from "./exam.controller.js";
const router = Router();
router.use(requireAuth, requireSchoolAccess, requireActiveSubscription);
router.get("/me/marksheets", requireRoles("STUDENT"), listMyMarkSheets);
...
router.get("/:id/marksheets", requireRoles("ADMIN", "TEACHER"), listMarkSheets);
router.put("/:id/marksheets", requireRoles("ADMIN", "TEACHER"), saveMarkSheets);
router.post("/:id/marksheets/publish", requireRoles("ADMIN", "TEACHER"), publishMarkSheets);
