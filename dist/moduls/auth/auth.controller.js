...
export async function register(req, res) {
    try {
        const { email, password, name, phone, schoolName, schoolEmail, schoolPhone, addressLine1, addressLine2, city, state, country, postalCode, } = req.body;
        if (!email || !password || !name || !schoolName) {
            throw badRequest("Email, password, name, and schoolName are required");
        }
...
export function handleControllerError(res, error, fallback) {
