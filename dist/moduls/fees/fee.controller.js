...
export async function upsertStudentFeePayment(req, res) {
    try {
        ...
        const schoolId = requireSchoolId(req);
        const { studentProfileId, academicYearId, year, month, status, amountDue: amountDueRaw, amountPaid, paidAt, notes, } = req.body;
        ...
        const amountDue = typeof amountDueRaw === "number"
            ? amountDueRaw
